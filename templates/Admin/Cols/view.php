...
<?php } ?>
											...
											<div class="row"><!-- 1. -->
												...
												<div class="col-sm-10 p-1 link">
													<?= $col->hasValue('status') ? $this->Html->link($col->status->status, ['controller' => 'Statuses', 'action' => 'view', $col->status->id]) : '' ?><span class="external-link-icon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
												</div>
											</div>
											<div class="row"><!-- 2. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Header') ?>:</label>
												<div class="col-sm-10 p-1">
													<?= h($col->header) ?>
