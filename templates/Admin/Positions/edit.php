...
$this->assign('title', __('Edit') . ' ' . __('Position'));
?>
				<div id="form-row" class="positions row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Position') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($position, ['id' => 'main-form']) ?>
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<div class="mb-3 form-group row text required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="id"><?= __('Id') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('id', ['type' => 'text', 'label' => __('Id'), 'placeholder' => __('Id'), 'class' => 'form-control', 'empty' => false, 'autofocus' => true]); ?>
											...
											<div class="mb-3 form-group row text required">
												...
												<div class="col-md-9">
													<?= $this->Form->control('name', ['label' => __('Name'), 'placeholder' => __('Name'), 'class' => 'form-control', 'empty' => false, 'autofocus' => false]); ?>
