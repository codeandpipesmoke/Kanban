...
$this->assign('title', __('Edit') . ' ' . __('Col'));
?>
				<div id="form-row" class="cols row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Col') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($col, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 1. SELECT: project_id: integer  required -->
