						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Tag') ?></h3>
...
<?php if (!empty($tag->tasks)) : ?>
												<li><?= $this->Html->link(__('Tasks') . '...', ['controller' => 'Tasks', 'action' => 'index', 'parent', 'tag', $tag->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
											</ul>
										</li>
...
<?php if($config['show_counters']){ ?>
											<div class="row"><!-- counter helper -->
												...
												<div class="col-sm-10 p-1">
													<?= $tag->task_count === null ? '' : $this->Number->format($tag->task_count) ?><!-- 3.a -->
												</div>
											</div>
<?php } ?>
...
<?php } ?>
											...
											<tbody>
												<?php foreach ($tag->tasks as $tasks) : ?>
