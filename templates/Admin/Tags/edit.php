...
$this->assign('title', __('Edit') . ' ' . __('Tag'));
?>
				<div id="form-row" class="tags row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Tag') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($tag, ['id' => 'main-form']) ?>
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<div class="mb-3 form-group row select">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end" for="tasks"><?= __('Tasks') ?>:</label>
												<div class="col-md-9">
													<?= $this->Form->control('tasks._ids', ['class' => 'form-control', 'placeholder' => __('Tasks'), 'options' => $tasks, 'data-live-search' => false, 'data-actions-box' => false, 'data-container' => 'body', 'data-size' => '6']); ?>
												</div>
											</div>
