						...
						<div class="card mb-3">
							...
							<div class="card-header">
								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-eye fa-spin"></i> <?= __('View') ?>: <?= __('Col') ?></h3>
									<?= __('The data marked with <span class="fw-bold text-danger">*</span> must be provided!') ?>
								</div>
								<div class="float-end ms-5">
									<?= $this->Html->link('<span class="btn btn-outline-secondary mt-1 me-1"><i class="fa fa-times"></i></span>',
										["controller" => "Cols", "action" => "index", "_full" => true],
...
<?php if (!empty($col->tasks)) : ?>
												<li><?= $this->Html->link(__('Tasks') . '...', ['controller' => 'Tasks', 'action' => 'index', 'parent', 'col', $col->id], ['class' => 'dropdown-item']) ?></li>
<?php endif ?>
											</ul>
										</li>
...
<?php } ?>
											<div class="row"><!-- 1. -->
												<label class="col-sm-2 col-form-label p-1 text-start text-sm-end"><?= __('Project') ?>:</label>
...
<?php if($config['show_counters']){ ?>
											<div class="row"><!-- counter helper -->
												...
												<div class="col-sm-10 p-1">
													<?= $col->task_count === null ? '' : $this->Number->format($col->task_count) ?><!-- 3.a -->
												</div>
											</div>
<?php } ?>
...
<?php } ?>
											...
											<tbody>
												<?php foreach ($col->tasks as $tasks) : ?>
