...
$this->assign('title', __('Edit') . ' ' . __('Tags Task'));
?>
				<div id="form-row" class="tagsTasks row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Tags Task') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($tagsTask, ['id' => 'main-form']) ?>
								...
								<div class="card-body">
									...
									<div class="tab-content" id="tabContent">
										...
										<div class="tab-pane fade show active" id="tabPanelMain" role="tabpanel" aria-labelledby="tabMain" tabindex="0">
											...
											<!-- 1. SELECT: tag_id: integer  required -->
											<div class="mb-3 form-group row select required">
												<label class="col-form-label col-md-2 pt-1 text-start text-md-end required" for="tag-id"><?= __('Tag Id') ?>:</label>
												<div class="col-md-4">
													<?= $this->Form->control('tag_id', ['options' => $tags, 'placeholder' => __('Tag Id'), 'class' => 'form-control select2', 'data-live-search' => false, 'data-container' => 'body', 'data-size' => '6', 'empty' => false]);	?>
