...
$this->assign('title', __('Edit') . ' ' . __('Color'));
?>
				<div id="form-row" class="colors row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Color') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($color, ['id' => 'main-form']) ?>
