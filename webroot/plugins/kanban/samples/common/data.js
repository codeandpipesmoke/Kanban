...
var base_task_set = [
	{ id:1, status:"new", text:"Task 1a", tags:"webix,docs", comments:[{text:"Comment 1"}, {text:"Comment 2"}] },
...
var task_set = [
	{ id:1, status:"new", text:"Task 1b", tags:"webix,docs" },
...
var user_task_set =[
	...
	{ id:2, status:"work", user: 1, text:"Performance tests 1", color:"#FE0E0E", tags:"webix"  },
	{ id:3, status:"work", user: 2, text:"Kanban tutorial 2", tags:"webix,docs", comments:[{text:"Comment 1"}] },
	{ id:4, status:"work", user: 3, text:"SpreadSheet NodeJS 3", tags:"webix 3.0"  },
	{ id:5, status:"test", user: 3, text:"Portlets view 4", tags:"webix 2.5"  }
];
var team_task_set =[
...
var task_set_with_comments = [
	...
	{ id:2, status:"work", user_id: 5, text:"Performance tests 111", tags:[1],
		comments:[
