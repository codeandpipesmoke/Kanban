...
$this->assign('title', __('Edit') . ' ' . __('Status'));
?>
				<div id="form-row" class="statuses row">
					<div class="col-xs-12 col-xl-10">
						<div class="card mb-3">
							<div class="card-header">

								<div class="float-start">
									<h3><i id="card-icon" class="fa fa-edit fa-spin"></i> <?= __('Edit') ?>: <?= __('Status') ?></h3>
...
*/ ?>
							...
							<?= $this->Form->create($status, ['id' => 'main-form']) ?>
